...
import static com.berhane.biniam.wallpack.wallpack.utils.DownloadHelper.DownloadType.DOWNLOAD;
...
public class DownloadHelper {
    ...
    @IntDef({DOWNLOAD, DownloadType.WALLPAPER})
    @Retention(RetentionPolicy.SOURCE)
    ...
    public long addDownloadRequest(@DownloadType int downloadType, String downloadUrl, String fileName) {
        ...
        DownloadManager.Request request = new DownloadManager.Request(Uri.parse(downloadUrl))
                .setTitle(fileName)
                .setDestinationInExternalPublicDir(PhotoConstants.DOWNLOAD_PATH, fileName)
    ...
    public String getFilePath(long id) {
        return Environment.getExternalStorageDirectory() + PhotoConstants.DOWNLOAD_PATH + getFileName(id);
    }
}
