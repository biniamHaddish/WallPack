...
public class CircularAuthorImage extends ImageView {
        // data.
        ...
        public CircularAuthorImage(Context context) {
            super(context);
            init();
        }

        public CircularAuthorImage(Context context, AttributeSet attrs) {
            this(context, attrs, 0);
        }

        public CircularAuthorImage(Context context, AttributeSet attrs, int defStyle) {
